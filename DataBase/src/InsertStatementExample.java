...
public class InsertStatementExample {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/anjigoud", "root",	"root12345");
			...
			// Prepare the Query to insert the data
			 int record=stmt.executeUpdate("INSERT INTO Employees VALUES (9, 9, 'nju', 'ingh')");
